...
const domain = {
  ...
  change: 'Змінити',
  description: 'Це адреса, яку ви використовуєте для входу у FieldBI',
  next: 'Далі',
  error: 'Адреса не вірна'
};
...
const auth = {
  ...
  email: 'E-mail',
  password: 'Пароль',
  error_login: "Неправильне ім'я користувача або пароль"
};
