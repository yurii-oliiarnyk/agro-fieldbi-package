...
const AgreementShowTable = props => {
  ...
  const data = [
    ...
    },
    {
      ...
      value: document.land && document.landShortData && document.landShortData.landNumber,
      render: (value, styles) => {
        const { textStyle, linkStyle } = styles;

        return (
          <TouchableOpacity onPress={() => onNamePress(value, document.land)}>
    ...
    },
    {
      ...
      value: document.tenantOrganization && document.tenantOrganizationShortData.name
    },
    {
      key: 'landlord',
      name: getLandlordOrganization(document.type),
      value: document.landlord && document.landlordShortData.name
    },
    {
      key: 'dateOfCreation',
...
AgreementShowTable.propTypes = {
  document: PropTypes.object.isRequired
};

export default AgreementShowTable;
