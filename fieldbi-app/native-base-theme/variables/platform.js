...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#007aff' : '#00A1FF',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#00A1FF',
  ...
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#00A1FF',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#00A1FF',
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#a7a6ab' : '#00A1FF',
  ...
  listItemSelected: platform === PLATFORM.IOS ? '#007aff' : '#00A1FF',
  ...
  radioSelectedColorAndroid: '#00A1FF',
  ...
  // Segment
  segmentBackgroundColor: platform === PLATFORM.IOS ? '#F8F8F8' : '#00A1FF',
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#00A1FF',
  segmentBorderColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentBorderColorMain: platform === PLATFORM.IOS ? '#a7a6ab' : '#00A1FF',
  ...
  tabDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#00A1FF',
